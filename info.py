...
API_ID = int(environ.get('API_ID', '19596753')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'c69ed1342d69c83984ce7449e2eb4114')  # API Hash from my.telegram.org
...
PICS = (environ.get('PICS', 'https://envs.sh/zT4.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://graph.org/file/56b5deb73f3b132e2bb73.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/890a69b683722940661c1.jpg'))
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002346350041')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-100')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+UCLPaEtv7T8yY2Jl')  # Support group link (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/890a69b683722940661c1.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'lahoriya315@axl')    # Owner UPI ID for payments
