...
DREAMCINEZONE_MOVIE_UPDATE_CHANNEL = int(environ.get('DREAMCINEZONE_MOVIE_UPDATE_CHANNEL', '--1002170760514'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002037836704'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002315275804')  # Channel/Group ID for force sub (make sure bot is admin)
...
DREAMCINEZONE_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DREAMCINEZONE_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/movie_update_channel0')
